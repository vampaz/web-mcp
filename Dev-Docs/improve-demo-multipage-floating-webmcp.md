...
- The expanded command UI must always be the library-provided `<webmcp-command-input>` from `webmcp-kit`; the demo should not recreate or fork command input behavior.
